        ...
        <div class="container bootstrap snippets bootdeys">
            <div class="row" id="user-profile">
                <div class="col-lg-3 col-md-4 col-sm-4">
                    <div class="main-box clearfix">
                        ...
                        <div class="profile-details">
                            <ul class="fa-ul">
                                <li><i class="fa-li fa fa-truck"></i>Đã orders: <span>${count}</span></li>
                            </ul>
                        </div>

                        <div class="profile-message-btn center-block text-center">
                            <a href="Logout" class="btn btn-success">
                                <i style="text-decoration: underline"> Đăng xuất </i>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-9 col-md-8 col-sm-8">
                    <div class="main-box clearfix" style="padding-bottom: 245px">
                        <div class="profile-header">
                            <h3><span>Thông tin của bạn</span></h3>
                            <a href="EditProfile" class="btn btn-primary edit-profile">
                            ...
                            <div class="col-sm-8">
                                <div class="profile-user-details clearfix">
                                    ...
                                    <div class="profile-user-details-value">
                                        ${a.realname==null||a.realname eq ""?"Chưa có thông tin":a.realname}
                                    </div>
                                </div>
                                <div class="profile-user-details clearfix">
                                    <div class="profile-user-details-label">
                                    ...
                                    <div class="profile-user-details-value">
                                        ${a.accountbalance==null?"Chưa có thông tin":a.accountbalance}
                                    </div>
                                </div>
                                <div class="profile-user-details clearfix">
                                    <div class="profile-user-details-label">
                                    ...
                                    <div class="profile-user-details-value">
                                        ${a.getGmail()==null||a.gmail eq ""?"Chưa có thông tin":a.gmail}
                                    </div>
                                </div>
                                <div class="profile-user-details clearfix">
                                    <div class="profile-user-details-label">
                                    ...
                                    <div class="profile-user-details-value">
                                        ${a.phone==null || a.phone eq ""?"Chưa có thông tin":a.phone}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="py-5">
                                <a href="ShopPage" class="btn btn-danger edit-profile" style="margin-right: 20px">
                                    Trang chủ
                                </a>
                                <a href="LoadIntoWallet" class="btn btn-success edit-profile" style="margin-right: 20px">
                                     Nạp tiền
                                </a>
                                <a href="ChangePass" class="btn btn-info edit-profile" style="margin-right: 20px">
                                    Đổi mật khẩu
                                </a>
                                <a href="ViewOrder" class="btn btn-warning edit-profile" style="margin-right: 20px">
                                    Lịch sử mua hàng
                                </a>
                            </div>         
                        </div>
