<%-- 
    Document   : login
    Created on : Mar 2, 2022, 9:08:56 PM
    Author     : admin
--%>
                                ...
                                <div class="col-lg-12">
                                    <form id="login-form" action="LoginPage" method="post" role="form" style="display: block;">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-6 col-sm-offset-3">
                                                    <a  name="login-submit" id="login-submit" tabindex="4" class="form-control btn btn-login" href="Register">Register</a>                               
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                    <h3 class="text-center text-danger">${mess}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
